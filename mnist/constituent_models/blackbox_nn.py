...
# description  : Makes a small neural network that is trained to distill an ensemble for facilitating blackbox attacks.
...
def get_model(x_train, y_train, x_test, y_test):
    x_train, y_train, x_test, y_test = process_data(x_train, y_train, x_test, y_test, toCategorical=True)
